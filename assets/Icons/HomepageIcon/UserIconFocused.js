...
export default function UserIconFocused({ width, height }) {
  const UserIconFocused = `<svg width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <title>DFC2FA2A-F96D-48A7-A0D1-CB976F0A0CA2</title>
    <g id="Android-" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="UI-KIT" transform="translate(-321.000000, -186.000000)" fill="#3AD06B">
