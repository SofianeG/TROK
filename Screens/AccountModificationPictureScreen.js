...
import AccountModificationPictureIcon from "../assets/Icons/AccountModificationPictureIcon";
...
function AccountModificationPictureScreen() {
  return (
      ...
      <View style={styles.wrapper_bottom}>
        <View>
          ...
          <View style={styles.icon}>
            <AccountModificationPictureIcon />
...
export default AccountModificationPictureScreen;
